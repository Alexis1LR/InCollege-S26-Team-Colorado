*> ===============================================================
      ...
      *> ===============================================================
       ...
       FILE-CONTROL.
          ...
          SELECT MSG-FILE ASSIGN TO "Messages.dat"
              ORGANIZATION IS LINE SEQUENTIAL
              FILE STATUS IS WS-MSG-ST.
    ...
    01  WS-APP-COUNT        PIC 9(5) VALUE 0.
    01  WS-APP-EOF          PIC X VALUE "N".
    01  WS-REPORT-JOB-ID    PIC 9(5) VALUE 0.

    01  WS-MSG-CHOICE       PIC X VALUE SPACE.
    01  WS-MSG-RECIP        PIC X(20) VALUE SPACES.
    01  WS-MSG-CONTENT      PIC X(200) VALUE SPACES.
    01  WS-MSG-CONNECTED    PIC X VALUE "N".
    01  WS-DATE             PIC 9(8) VALUE 0.
    01  WS-TIME             PIC 9(6) VALUE 0.
    01  WS-TIMESTAMP        PIC X(14) VALUE SPACES.
    01  WS-MSG-COUNT        PIC 9(4) VALUE 0.
    01  WS-MSG-DISPLAY-TS   PIC X(25) VALUE SPACES.
